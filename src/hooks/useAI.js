...
import { barracksCapacity, maxAvailLevel, upgCost } from “../constants/buildings.js”;
import { AI_HQ_KEY, WIN_C, WIN_R } from “../constants/map.js”;
import { adj } from “../utils/pathfinding.js”;
...
n[t.rss] += 50 * Math.max(1, aiRssRef.current[bldgForRss] || 1);
}
});
return {
...
}, [screen, aiFaction, setAiRss, tilesRef, aiRssRef]);
